                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <Row>
                                        <Col sm="4">
                                            <Label for="performer_initial-1">頭文字を選択</Label>
                                        ...
                                        <Col sm="8">
                                            <Label for="performer_name-1">名前をリストから選択</Label>
                                            <Input type="select" name="performer_name-1" id="performer_name-1" placeholder="名前をリストから選択" />
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col sm="4"><Input type="select" name="performer_initial" id="performer_initial-2" placeholder="頭文字を選択" /></Col>
                                        <Col sm="8"><Input type="select" name="performer_name" id="performer_name-2" placeholder="名前をリストから選択" /></Col>
                                    </Row>
                                    <Row>
...
const PerformerInput = (key) => {
    ...
    return (
        <Row key={key.toString()}>
            ...
            <Col sm="6"><Input type="select" name={performer_name} id={performer_name} placeholder="名前をリストから選択" /></Col>
        </Row>
    );
}